...
public class test {
	...
	public void randkey(){
		keys[1] = (byte) new Random().nextInt(1);
		keys[4] = (byte) new Random().nextInt(1);
		keys[7] = (byte) new Random().nextInt(1);
		keys[11] = (byte) new Random().nextInt(1);
		keys[12] = (byte) new Random().nextInt(1);
		keys[13] = (byte) new Random().nextInt(1);
		keys[14] = (byte) new Random().nextInt(1);
		keys[15] = (byte) new Random().nextInt(1);
